...
public class AuthUser implements Serializable {
	...
	public AuthUser(String id, String email, String firstName, String lastName, Calendar expiration, Long sub,
			String jti, String loginSource, String tawkHash, String userType, String gdprEmailPolicy,
			Boolean firstTimeSignedIn) {
		super();
		this.id = id;
		this.email = email;
